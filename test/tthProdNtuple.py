...
pileup       = os.path.join(
  os.environ['CMSSW_BASE'], 'src/tthAnalysis/HiggsToTauTau/data/pileup_%s_nano.root' % era
)
...
if mode == 'sync':
  ...
  samples = load_samples(era, preselection, suffix = 'base' if preselection else 'nano')
